...
nlp = spacy.load(
    "en_core_web_md"
)  # Ensure you have a medium or larger model for word vectors
...
def find_wordnet_synonyms(word: str):
    """
    Find synonyms of a given word using WordNet from NLTK.
...
if __name__ == "__main__":
    ...
    word = "happy"
    print(f"Words similar to '{word}' (spaCy):")
    try:
